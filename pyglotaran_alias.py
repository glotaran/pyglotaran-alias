"""Enables 'import pyglotrana' as well as the default 'import glotaran'."""
...
try:
    ...
    modules_to_update = {}
    for fullname, glorana_module in sys.modules.items():
        if fullname == "glotaran" or fullname.startswith("glotaran."):
            modules_to_update[f"py{fullname}"] = glorana_module
